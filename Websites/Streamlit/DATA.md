...
## 1. Home.py
# 2010-2025
- data/all_team_game_logs.csv (**_2020-2025_**)
- data/SR-game-logs/all_teams_game_logs_2024.csv (**_2024_**)
- data/SR-game-logs/all_teams_game_logs_2025.csv (**_2025_**)
- data/odds/nfl_odds_movements.csv
- data/odds/nfl_odds_movements_circa.csv
- data/Teams.csv
- data/Games.csv (**_2010-2025_**)
- data/PlayerStats.csv (**_2010-2024_**)
- data/all_teams_schedule_and_game_results_merged.csv (**_2010-2025_**)
- data/all_passing_rushing_receiving.csv (**_2020-2025_**)
- data/player_stats_pfr.csv (**_2010-2025_**)
- data/rosters/*.csv (**_2010-2025_**)

## 2. Matchup Generator (00_⚔️_Matchup_Generator.py)
# 2010-2025
- data/Games.csv (**_2010-2025_**)
- data/PlayerStats.csv (**_2010-2024_**)
- data/rosters/roster_2025.csv (**_2025_**)
- data/all_team_game_logs.csv (**_2020-2025_**)
- data/all_defense-game-logs.csv (**_2020-2025_**)
- data/all_redzone.csv (**_2010-2025_**)
...
- data/all_team_game_logs.csv (**_2020-2025_**)
- data/all_teams_schedule_and_game_results_merged.csv (**_2010-2025_**)
- data/all_box_scores.csv (**_2020-2025_**)
- data/SR-game-logs/all_teams_game_logs_2024.csv (**_2024_**)
- data/SR-game-logs/all_teams_game_logs_2025.csv (**_2025_**)
