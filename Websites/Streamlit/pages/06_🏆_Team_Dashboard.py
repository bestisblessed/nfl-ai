...
def load_data():
    """Load all required CSV files for Team Dashboard"""
    ...
    try:
        ...
        return (df_teams, df_games, df_playerstats, df_team_game_logs, 
                ...
                df_team_game_logs_2024, df_team_game_logs_2025)
...
(df_teams, df_games, df_playerstats, df_team_game_logs, 
 df_schedule_and_game_results, df_all_passing_rushing_receiving,
 df_team_game_logs_2024, df_team_game_logs_2025) = load_data()
...
colors_pass = plt.colormaps.get_cmap('magma').resampled(len(team_averages_pass_sorted))
colors_rush = plt.colormaps.get_cmap('magma').resampled(len(team_averages_rush_sorted))
colors_combined = plt.colormaps.get_cmap('magma').resampled(len(team_averages_combined_sorted))
