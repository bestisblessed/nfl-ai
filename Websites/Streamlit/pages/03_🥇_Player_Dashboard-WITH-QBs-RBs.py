    ...
    if player_name is not None:
        ...
        if not season_2025_data.empty:
            ...
            if player_position == 'QB':
                ...
                with metric_col2:
                    avg_pass_per_game = season_2025_data['pass_yds'].mean() if 'pass_yds' in season_2025_data.columns else 0
                    st.metric(
                        label="Avg Pass/Game",
                        value=f"{avg_pass_per_game:.1f}",
                ...
                with metric_col2:
                    avg_rush_per_game = season_2025_data['rush_yds'].mean() if 'rush_yds' in season_2025_data.columns else 0
                    st.metric(
                        label="Avg Rush/Game",
                        value=f"{avg_rush_per_game:.1f}",
                ...
                with metric_col3:
                    ...
                    st.metric(
                        label="Total Rush TDs",
                        value=f"{total_rush_tds:.0f}",
                        help="Total rushing touchdowns (2025)"
                    )
