...
if [ $# -eq 0 ]; then
    echo "=== NFL Passing Yards Predictions ==="
...
python xgboost_passing_yards_qb.py $WEEK_NUM
echo ""
echo "=== All predictions complete for Week $WEEK_NUM ==="

echo ""
echo "Merging QB reports into single files..."
python generate_txt_reports.py $WEEK_NUM
echo ""
echo "Creating HTML reports for QB..."
