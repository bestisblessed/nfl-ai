#!/usr/bin/env python3
"""
Build training features/labels for Anytime TD (WR/RB/TE + QB rushing-only)
and write compact inference inputs for the upcoming week.
"""
...
def build_training_dataset() -> pd.DataFrame:
    ...
    # Fill missing positions using 2025 roster map (player_id -> position)
    try:
...
def main():
    print("Preparing Anytime TD datasets (4-TOUCHDOWNS)...")
