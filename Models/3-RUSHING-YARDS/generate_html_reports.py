...
def create_html_report_for_position(week_num, position):
    ...
    # Create HTML file
    html_file = f"{predictions_dir}/final_week{week_num}_{position}_rush_yards_report.html"
...
<head>
    ...
    <title>Week {week_num} {position} Rushing Yards Predictions</title>
    <style>
        body {{
...
<body>
    <div class="header">
        <h1>Week {week_num} {position} Rushing Yards Predictions</h1>
