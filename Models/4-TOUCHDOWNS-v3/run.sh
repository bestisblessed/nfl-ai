...
SCRIPT_DIR="/Users/td/Code/nfl-ai/Models/4-TOUCHDOWNS-v3"
...
# Data prep
echo "--- Preparing Data for 4-TOUCHDOWNS-v3 ---"
mkdir -p "$DATA_DIR"
cd "$SCRIPT_DIR"
...
cp ../../Scrapers/final_data_pfr/game_logs_pfr.csv data/ 2>/dev/null || true
...
echo "--- Building Anytime TD Features (v3) ---"
python "$SCRIPT_DIR/prepare_data_v3.py"

echo "--- Running Anytime TD XGBoost (v3) ---"
python "$SCRIPT_DIR/xgboost_anytime_td_v3.py" $WEEK

echo "--- Generating Anytime TD HTML Report (v3) ---"
