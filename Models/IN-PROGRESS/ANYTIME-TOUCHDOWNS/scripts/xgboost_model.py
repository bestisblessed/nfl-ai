"""XGBoost-based touchdown probability model."""
...
def main(upcoming_path: str | None = None) -> None:
    ...
    print("\n=== Upcoming Week Touchdown Probabilities (XGBoost) ===")
    ...
    output_path = Path(__file__).resolve().parents[0] / "xgboost_predictions.csv"
