...
def merge_position_reports(week_num, position):
    ...
    output_file = f"{predictions_dir}/final_week{week_num}_{position}_rec_yards_report.txt"
    
    with open(output_file, 'w') as outfile:
        # Write header
        position_name = {"WR": "WR RECEIVING YARDS", "RB": "RB RECEIVING YARDS", "TE": "TE RECEIVING YARDS"}
        ...
        outfile.write("=" * 80 + "\n")
        outfile.write(f"This report contains all {position} receiving yards predictions for Week " + str(week_num) + ".\n")
        ...
        outfile.write("\nFor the complete dataset, see: prop_projections_receiving.csv\n")
        outfile.write("=" * 80 + "\n")
