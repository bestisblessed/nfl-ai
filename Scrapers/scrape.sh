...
echo "================================================================================="
echo "STARTING NFL DATA SCRAPER (2010-2025 seasons, filtering unplayed games after week $WEEK_LIMIT)"
echo "================================================================================="
python -u ScraperFinal.py 2>&1 | tee log.txt

echo ""
echo "================================================================================="
echo "PFR ONLY DATABASE (2010-2025 seasons, filtering unplayed games after week $WEEK_LIMIT)"
echo "================================================================================="
