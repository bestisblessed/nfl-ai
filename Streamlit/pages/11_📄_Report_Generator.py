...
# #             summary_team1 = historical_stats_team1.groupby('player_display_name').agg({
# #                 'receptions': 'mean',
# #                 'targets': 'mean',
...
# #             }).reset_index()
# #             summary_team1['games_played'] = historical_stats_team1.groupby('player_display_name')['game_id'].nunique().values
# #             st.write(f"\n**Average Historical Stats per Game for {team1} players vs {team2}:**")
# #             st.write(summary_team1)
# #         else:
# #             st.write(f"No historical stats found for {team1} players vs {team2}.")

# #         if not historical_stats_team2.empty:
# #             summary_team2 = historical_stats_team2.groupby('player_display_name').agg({
# #                 'receptions': 'mean',
# #                 'targets': 'mean',
# #                 'receiving_yards': 'mean',
# #                 'receiving_tds': 'mean',
...
# #                 'fantasy_points_ppr': 'mean'
# #             }).reset_index()
# #             summary_team2['games_played'] = historical_stats_team2.groupby('player_display_name')['game_id'].nunique().values
# #             st.write(f"\n**Average Historical Stats per Game for {team2} players vs {team1}:**")
# #             st.write(summary_team2)
# #         else:
